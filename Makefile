...
#    Updated: 2019/07/10 13:40:33 by rgendry          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES = ft_strlen.c ft_bzero.c ft_atoi.c ft_strdup.c\
ft_param.c print_o.c reshetka_o.c ft_printf_x.c reshetka.c printf_itoabase.c\
